                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      disabledBackgroundColor: ElevateTheme.quick.withValues(alpha: 0.3),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ? [
                  BoxShadow(
                    color: ElevateTheme.quick.withValues(alpha: 0.4),
                    blurRadius: 16,
        ...
        Row(
          children: [
            Icon(
              ...
              color: ElevateTheme.warning.withValues(alpha: volume / 100),
              size: 24,
            ),
            Expanded(
              child: Slider(
